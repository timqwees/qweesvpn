...
<body class="bg-black flex item-center justify-center">
  <div class="min-h-screen flex flex-col justify-center items-center container">
    ...
    <div
      ...
      <form action="/auth/login" method="POST">
        ...
        <div class="flex flex-col gap-4 w-full" id="part1">
          ...
          <!-- BUTTON -->
          <button data-button="email" onclick="return false" class="bg-[#6BFF5B] p-2 text-center rounded-2xl font-sans"
          ...
          <div class="flex flex-col gap-4 w-full">
            ...
            <div class="flex flex-col md:flex-row justify-center items-center gap-4">
              ...
              <button data-button="verefy" type="submit"
                class="w-full flex-1 bg-[#6BFF5B] p-2 text-center rounded-2xl font-sans" disabled>Войти</button>
            </div>
    ...
    <!-- customized scripts -->
    <script defer src="/public/assets/scripts/auth/login/main.js"></script>
    <!--  -->
