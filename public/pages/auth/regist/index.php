        ...
        <div
            ...
            <form action="/auth/regist" method="POST">
                ...
                <div class="flex flex-col gap-4 w-full" id="part1">
                    <!-- INPUT = first_name -->
                    <label for="first_name" class="text-white/70 text-2xl font-sans"><?= $t('first_name') ?></label>
                    ...
                    <!-- INPUT = last_name -->
                    <label for="last_name" class="text-white/70 text-2xl font-sans"><?= $t('last_name') ?></label>
                    <div class="relative flex">
                        <i class="fa fas fa-user text-white absolute left-5 top-[35%]"></i>
                    ...
                    <a href="/auth/login"
                        ...
                        <img src="/public/assets/images/icons/services/auth/auth.svg"> <?= $t('login') ?></a>
                </div>
