        ...
        <header class="fixed z-50 left-0 top-2 right-0 h-16 px-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <h2 class="text-white text-xl font-[qwees-poppins-medium] tracking-wider">
                    Qwees<span class="text-green-400">VPN</span></h2>
            </div>
            <!-- version -->
        ...
        <main class="flex sm:my-2 w-full">
            ...
            <div class="hidden sm:block w-full text-white">
                ...
                <section data-section="main"
                    class="overflow-hidden relative min-h-[100dvh] flex flex-col gap-2 justify-between pb-4 box-border w-full bg-gradient-to-t from-black via-green-950 to-black">
                    <!-- background -->
                    ...
                    <!-- text -->
                    <div
                        class="px-4 py-[15%] mx-auto right-0 left-0 flex flex-col justify-center items-center gap-3 z-10">
                        <div class="p-8 bg-[#181818] aspect-square rounded-[30px]">
                            <img decoding="async" loading="lazy" class="w-14"
                                src="/public/assets/images/icons/logo/qweesvpn.svg" alt="logo">
                        </div>
                ...
                <section data-section="start"
                    class="hidden overflow-hidden relative flex flex-col gap-2 justify-end items-center pb-4 box-border w-full min-h-[100dvh] bg-black">
                    <!-- background -->
                    <img decoding="async" loading="lazy" src="/public/assets/images/background/map.svg" alt="map"
