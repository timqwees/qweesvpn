### v3.15.1 от 13.08.2026
* Добавлена документация по платежным табличкам `pos_links`
* Расширена максимальная длина телефона для `Supplier.phone` (до 19 символов)

### v3.15.0 от 12.08.2026
* Добавлена поддержка платежных табличек `pos_links`
* Добавлены `loan_declined`, `loan_declined_by_payer`, `loan_application_expired` в причинах отмены платежа
