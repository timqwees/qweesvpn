...
| public | [$sbp_operation_id](../classes/YooKassa-Model-Payout-PayoutDestinationSbp.md#property_sbp_operation_id) |  | Идентификатор операции в СБП (НСПК). |
| public | [$sbpOperationId](../classes/YooKassa-Model-Payout-PayoutDestinationSbp.md#property_sbpOperationId) |  | Идентификатор операции в СБП (НСПК). |
...
| public | [getSbpOperationId()](../classes/YooKassa-Model-Payout-PayoutDestinationSbp.md#method_getSbpOperationId) |  | Возвращает sbp_operation_id. |
...
| public | [setSbpOperationId()](../classes/YooKassa-Model-Payout-PayoutDestinationSbp.md#method_setSbpOperationId) |  | Устанавливает sbp_operation_id. |
